...
import { apiGet, apiPatch, craeteBrowserApiClient } from "@/lib/api-client";
...
function ProfilePage() {
  ...
  async function onSubmit(values : ProfileFormValues) {
     try {
      ...
      const apiResponse = await apiPatch<typeof payload , UserResponse>(
        apiClient , "/api/me/update" , payload
      )
      ...
      toast.success("Profile Updated Successfully!",
        {description : "Your changes have saved successfully!"}
      )
  ...
  return (
    <>
      <SignedOut>User sign out</SignedOut>
      <SignedIn>
            ...
            <CardHeader className="pb-4">
              <div className="flex items-start gap-6 ">
               <Avatar className="h-20 w-20  rounded-full">
                 {
                  avatarUrlValue && <AvatarImage className="rounded-full object-contain" src={avatarUrlValue || "/placeholder.xyz"}
          ...
          <Card className="border-border/70 bg-card">
            ...
            <CardContent>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                {/* Implement Error State : To Do List */}
                ...
                <div className="grid gap-6 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    className="border-border bg-background/60 mt-2 text-sm"
                    />
                  </div>
                  <div className="space-y-2">
